...
function downloadTemplate() {
  const template = [
    ...
    'AAPL,Apple Inc.,stock,tfsa,50,142.50,USD,NASDAQ,20',
    'BMO:CA,Bank of Montreal,stock,rrsp,100,80.00,CAD,TSX,15',
    'VOO,Vanguard S&P 500 ETF,etf,rrsp,20,380.00,USD,NYSE,35',
